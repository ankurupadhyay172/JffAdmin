...
abstract class BaseRecyclerAdapter<T:Any,VB:ViewDataBinding>:RecyclerView.Adapter<BaseRecyclerAdapter.Companion.BaseViewHolder<VB>>() {

    var items = mutableListOf<T>()

    var listner:((view:View,item:T,position:Int)->Unit)? = null
